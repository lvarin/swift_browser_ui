...
export class CDataTable {
        ...
        "complexType": {
          ...
          "references": {
            "CDataTableData": {
              "location": "import",
              "path": "../../types",
              "id": "src/types/index.ts::CDataTableData"
            }
          }
        },
        "required": false,
        ...
        "complexType": {
          ...
          "references": {
            "CDataTableHeader": {
              "location": "import",
              "path": "../../types",
              "id": "src/types/index.ts::CDataTableHeader"
            }
          }
        },
        "required": false,
        ...
        "complexType": {
          ...
          "references": {
            "CDataTableFooterOptions": {
              "location": "import",
              "path": "../../types",
              "id": "src/types/index.ts::CDataTableFooterOptions"
            }
          }
        },
        "required": false,
  ...
  static get methods() {
    return {
      ...
      "getData": {
        "complexType": {
          "signature": "() => Promise<Record<string, string | number | boolean>[]>",
          "parameters": [],
          "references": {
            "Promise": {
              "location": "global",
          ...
          "return": "Promise<Record<string, string | number | boolean>[]>"
        },
        "docs": {
          "text": "Provide sorted data",
          "tags": []
        }
      }
    };
  ...
  static get watchers() {
    return [{
        ...
        "methodName": "onHiddenHeaderChange"
      }, {
        "propName": "data",
