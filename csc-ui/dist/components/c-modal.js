...
const CModal$1 = proxyCustomElement(class CModal extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return cModalCss; }
}, [1, "c-modal", {
    "value": [1028],
    "dismissable": [4],
    "width": [8],
...
function defineCustomElement$1() {
  ...
  const components = ["c-modal"];
  components.forEach(tagName => { switch (tagName) {
    case "c-modal":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CModal$1);
      }
      break;
  } });
}

const CModal = CModal$1;
const defineCustomElement = defineCustomElement$1;

export { CModal, defineCustomElement };
