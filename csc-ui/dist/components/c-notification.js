...
const CNotification$1 = proxyCustomElement(class CNotification extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return cNotificationCss; }
}, [1, "c-notification", {
    "notification": [16],
    "position": [1],
    "items": [32]
...
function defineCustomElement$1() {
  ...
  const components = ["c-notification"];
  components.forEach(tagName => { switch (tagName) {
    case "c-notification":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CNotification$1);
      }
      break;
  } });
}

const CNotification = CNotification$1;
const defineCustomElement = defineCustomElement$1;

export { CNotification, defineCustomElement };
