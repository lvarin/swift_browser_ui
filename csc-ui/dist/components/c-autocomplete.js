...
import { d as mdiChevronDown, m as mdiAlert } from './mdi.js';
...
const CAutocomplete$1 = proxyCustomElement(class CAutocomplete extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
CAutocomplete$1._uniqueId = 0;
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["c-autocomplete", "c-input", "c-message"];
  components.forEach(tagName => { switch (tagName) {
    case "c-autocomplete":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CAutocomplete$1);
      }
      break;
    case "c-input":
      if (!customElements.get(tagName)) {
...
const CAutocomplete = CAutocomplete$1;
const defineCustomElement = defineCustomElement$1;

export { CAutocomplete, defineCustomElement };
