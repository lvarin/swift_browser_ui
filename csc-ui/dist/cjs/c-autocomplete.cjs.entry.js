...
const CAutocomplete = class {
  ...
  _renderChevron() {
    ...
    return (index.h("svg", { class: classes, viewBox: "0 0 24 24" }, index.h("path", { d: mdi.mdiChevronDown })));
  }
  _renderEmptyMenu() {
    return (index.h("ul", { class: "c-input-menu__items c-input-menu__items--empty" }, index.h("li", { tabindex: "-1" }, index.h("svg", { viewBox: "0 0 24 24" }, index.h("path", { d: mdi.mdiAlert })), "No suggestions found")));
  }
  _renderCustomMenu(style) {
    ...
    return (index.h("div", { class: {
      ...
      } }, !!this.items.length && this.menuVisible && (index.h("div", { id: 'results_' + this._id, class: this.menuVisible
        ? 'c-input-menu__items'
        : 'c-input-menu__items c-input-menu__items--hidden', style: style }, index.h("slot", { name: "customMenu" }))), !this.items.length &&
      this.menuVisible &&
      this.query.length > 0 &&
  ...
  _renderMenu(style) {
    return (index.h("div", { class: {
        'c-input-menu__item-wrapper': true,
        'c-input-menu__item-wrapper--shadow': this.shadow,
      } }, !!this.items.length && (index.h("ul", { id: 'results_' + this._id, class: this.menuVisible
        ? 'c-input-menu__items'
        : 'c-input-menu__items c-input-menu__items--hidden', role: "listbox", style: style }, this.menuVisible &&
      this.items.map((item, index$1) => (index.h("li", { id: `option--${this._id}-${index$1}`, "aria-posinset": (index$1 + 1).toString(), "aria-setsize": this.items.length.toString(), "aria-selected": (this.currentIndex === index$1).toString(), role: "option", tabindex: "-1", ref: (el) => {
          item.ref = el;
          this._itemRefs.push({
            value: item.value,
            ref: el,
  ...
  _renderInputElement() {
    var _a;
    return (index.h("div", { class: "c-input-menu__input" }, index.h("input", { type: "text", "aria-expanded": this.menuVisible.toString(), "aria-owns": 'results_' + this._id, "aria-autocomplete": "list", "aria-activedescendant": this._getActiveListItemId(), autocomplete: "off", class: "c-input__input", role: "combobox", value: this.query, name: (_a = this.name) !== null && _a !== void 0 ? _a : null, onInput: (event) => this.handleChange(event), onFocus: (event) => this._handleFocus(event) })));
  }
  render() {
    this._itemRefs = [];
    ...
    return (index.h(index.Host, null, index.h("div", { id: 'announce-' + this._id, class: "visuallyhidden", "aria-live": "polite", "aria-atomic": "true" }, this.statusText), index.h("c-input", { autofocus: this.autofocus, disabled: this.disabled, "hide-details": this.hideDetails, hint: this.hint, id: this.hostId, "input-id": this._inputId, label: this.label, name: this.name, placeholder: this.placeholder, required: this.required, shadow: this.shadow, valid: this.valid, validate: this.validate, "validate-on-blur": this.validateOnBlur, validation: this.validation, value: this.query }, index.h("slot", { name: "pre", slot: "pre" }), index.h("div", { class: "c-input__content" }, this._renderInputElement(), this.customMenu
      ? this._renderCustomMenu(itemsPerPageStyle)
      : this._renderMenu(itemsPerPageStyle), this._renderChevron()), index.h("slot", { name: "post", slot: "post" }))));
  }
...
//# sourceMappingURL=c-autocomplete.cjs.entry.js.map
