...
const CAccordionItem = class {
  ...
  _getIcon() {
    return index.h("svg", { viewBox: "0 0 24 24" }, this._icons[this.icon]);
  }
  componentWillLoad() {
  ...
  render() {
    ...
    return (index.h("div", { class: hostClasses }, index.h("button", { id: `header__${CAccordionItem._uniqueId}`, "aria-controls": `panel__${CAccordionItem._uniqueId}`, "aria-expanded": this.expanded.toString(), "aria-label": this.heading, class: headerClasses, tabindex: "0", onClick: () => this._toggle() }, index.h("div", { class: "c-accordion-item__icon" }, !!this.icon ? this._getIcon() : index.h("slot", { name: "icon" })), index.h("div", { class: "c-accordion-item__title" }, this.heading), index.h("div", { class: indicatorClasses }, index.h("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", class: this.expanded && 'expanded', xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { fill: "var(--csc-primary)", d: "M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z" })))), index.h("div", { class: "c-accordion-item__content-wrapper" }, index.h("div", { id: `panel__${CAccordionItem._uniqueId}`, class: "c-accordion-item__content", role: "region", "aria-labelledby": `header__${CAccordionItem._uniqueId}` }, this.expanded && index.h("slot", null)))));
  }
};
CAccordionItem._uniqueId = 0;
CAccordionItem.style = cAccordionItemCss;

exports.c_accordion_item = CAccordionItem;

//# sourceMappingURL=c-accordion-item.cjs.entry.js.map
