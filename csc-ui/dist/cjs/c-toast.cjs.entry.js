...
const CToast = class {
  ...
  _renderCloseButton() {
    ...
    return (index.h(Tag, { "aria-label": "close", size: "small", text: true, onClick: () => this.closeToast() }, index.h("svg", Object.assign({}, Object.assign({}, (!!this.message.closeText && { slot: 'icon' })), { "aria-hidden": "true", viewBox: "0 0 24 24" }), index.h("path", { d: this._icons.close })), this.message.closeText));
  }
  render() {
    const showProgressBar = !this.message.persistent && this.message.progress;
    return (index.h(index.Host, { id: `c-toast--${this.message.id}`, class: { [this.message.type]: true }, role: "alert", "aria-atomic": "true", "aria-live": "assertive", onMouseEnter: () => this._onMouseEnter(), onMouseLeave: () => this._onMouseLeave() }, index.h("span", { class: "visuallyhidden" }, this.message.type, " notification"), this.message.custom ? (index.h("div", { class: "c-toast__custom-item" }, index.h("div", { class: "c-toast__content" }, index.h("slot", null)))) : (index.h("div", { class: "c-toast__item" }, index.h("svg", { viewBox: "0 0 24 24" }, index.h("path", { d: this._icons[this.message.type] })), index.h("div", { class: "c-toast__content" }, !!this.message.title && index.h("p", null, this.message.title), this.message.message), !this.message.indeterminate && this._renderCloseButton())), showProgressBar && (index.h("div", { class: "c-toast__progress", style: { '--c-toast-duration': `${this.message.duration}ms` } }, index.h("div", { class: {
...
exports.c_toast = CToast;

//# sourceMappingURL=c-toast.cjs.entry.js.map
