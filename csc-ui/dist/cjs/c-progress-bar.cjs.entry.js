...
const CProgressBar = class {
  ...
  render() {
    ...
    return (index.h(index.Host, Object.assign({}, a11y), index.h("label", { class: classes, style: style }, index.h("progress", Object.assign({}, params), !this.indeterminate && `${value}%`)), !this.indeterminate && !this.hideDetails && (index.h("div", { class: detailsClasses }, this.value, " % ", this.label))));
  }
};
CProgressBar.style = cProgressBarCss;

exports.c_progress_bar = CProgressBar;

//# sourceMappingURL=c-progress-bar.cjs.entry.js.map
