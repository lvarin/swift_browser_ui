...
const CMenu = class {
  ...
  _renderCustomTrigger() {
    ...
    return (index.h(Tag, Object.assign({}, params, { class: "custom-menu-trigger", "aria-expanded": this.active.toString(), "aria-haspopup": "listbox", "aria-controls": `c-menu-items-${CMenu._uniqueId}`, onClick: () => this._onClick() }), props.value));
  }
  render() {
    const hostClasses = {
      'c-menu': true,
    ...
    return (index.h(index.Host, { class: hostClasses }, this.customTrigger ? (this._renderCustomTrigger()) : (index.h("button", { "aria-expanded": this.active.toString(), "aria-haspopup": "listbox", "aria-controls": `c-menu-items-${CMenu._uniqueId}`, class: {
        'c-menu-wrapper': !this.simple,
        simple: this.simple,
      }, tabindex: "0", type: "button", onClick: () => this._onClick() }, this.simple ? (index.h("slot", null)) : (index.h("div", { class: "c-menu__header" }, index.h("slot", null), index.h("svg", { width: this.small ? '16' : '22', height: this.small ? '16' : '22', viewBox: "0 0 24 24", class: this.active
        ? 'c-menu__icon c-menu__icon--rotated'
        : 'c-menu__icon' }, index.h("path", { d: mdi.mdiChevronDown }))))))));
  }
