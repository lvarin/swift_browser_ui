...
const COtpInput = class {
  ...
  _renderInput(index$1) {
    return (index.h("input", { id: `c-otp-input--${COtpInput._uniqueId}-${index$1 + 1}`, ref: (el) => (this._inputs[index$1] = el), "aria-label": `Enter code - digit number - ${index$1 + 1} of ${this.length}`, type: "tel", maxlength: "1", onFocus: () => this._onFocus(index$1), onInput: (event) => this._onInput(event), onKeyDown: (event) => this._onKeyDown(event), onPaste: (event) => index$1 === 0 && this._onPaste(event) }));
  }
  componentWillLoad() {
  ...
  render() {
    ...
    return (index.h(index.Host, { id: this.id, style: { '--c-otp-input-count': this.length.toString() } }, index.h("div", { id: 'announce-' + this.id, class: "visuallyhidden", "aria-live": "polite", "aria-atomic": "true" }, this.statusText), index.h("div", { class: classes }, new Array(this.length)
      .fill(0)
...
//# sourceMappingURL=c-otp-input.cjs.entry.js.map
